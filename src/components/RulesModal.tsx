...
export default function RulesModal({ handleOnClick }: ModalProps) {
    return(
        <div className="bg-[var(--light-font)] rounded-lg absolute z-2 top-14 px-12 py-8">
            ...
            <Image src={rules} alt="Rules: Scissors > Paper > Rock > Lizard > Spock > Scissors" width={425} />
        </div>
    )
}